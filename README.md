...
- BA Agent v2.3.0: CRITICAL - QA endpoint validator with live curl testing, enhanced context preservation, source-first constraints, improved file persistence verification
