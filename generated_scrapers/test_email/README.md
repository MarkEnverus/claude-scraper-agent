...
Automated data collector for TestEMAIL test_data data.

## Overview

This scraper collects test_data data from TestEMAIL using their EMAIL_IMAP interface.
...
| `KAFKA_TOPIC` | No | Kafka topic (default: test_email_test_data) |
...
| `--dgroup` | Data group identifier (default: test_email_test_data) |
...
```bash
export TEST_EMAIL_API_KEY="your-api-key"
...
```
s3://your-bucket/
└── test_email_test_data/
    └── YYYY/
        └── MM/
            └── DD/
                └── test_email_test_data_ENDPOINT_YYYYMMDD_HHMMSS_VERSION.json
```

Example:
```
s3://production-data/test_email_test_data/2025/01/15/test_email_test_data_test_20250115_143022_001.json
```
...
{
    "event": "new_file",
    "dgroup": "test_email_test_data",
    "source": "testemail",
    "data_type": "test_data",
    "endpoint": "test",
    "date": "2025-01-15",
    "s3_path": "s3://bucket/test_email_test_data/2025/01/15/file.json",
    "file_hash": "abc123...",
...
```bash
pytest tests/test_email/test_scraper_test_email_test_data_http.py -v
```
...
```bash
export TEST_EMAIL_API_KEY="your-api-key"
pytest tests/test_email/test_scraper_test_email_test_data_http.py -v -m integration
```

### Test Coverage

```bash
pytest tests/test_email/ --cov=test_email --cov-report=html
```
...
- Verify TEST_EMAIL_API_KEY is set correctly
...
python -m claude_scraper.updater \
    --scraper scraper_test_email_test_data_http.py \
