# TestWEBSITE Test_data Data Collector

Automated data collector for TestWEBSITE test_data data.

## Overview

This scraper collects test_data data from TestWEBSITE using their WEBSITE_PARSER interface.

- **Data Source**: TestWEBSITE
...
This scraper collects data from 1 endpoints:
...
| `KAFKA_TOPIC` | No | Kafka topic (default: test_website_test_data) |
...
```bash
python scraper_test_website_test_data_http.py \
...
| `--dgroup` | Data group identifier (default: test_website_test_data) |
...
```bash
export TEST_WEBSITE_API_KEY="your-api-key"
...
```
s3://your-bucket/
└── test_website_test_data/
    └── YYYY/
        └── MM/
            └── DD/
                └── test_website_test_data_ENDPOINT_YYYYMMDD_HHMMSS_VERSION.json
```

Example:
```
s3://production-data/test_website_test_data/2025/01/15/test_website_test_data_test_20250115_143022_001.json
```
...
{
    "event": "new_file",
    "dgroup": "test_website_test_data",
    "source": "testwebsite",
    "data_type": "test_data",
    "endpoint": "test",
    "date": "2025-01-15",
    "s3_path": "s3://bucket/test_website_test_data/2025/01/15/file.json",
    "file_hash": "abc123...",
...
```bash
pytest tests/test_website/test_scraper_test_website_test_data_http.py -v
```
...
```bash
export TEST_WEBSITE_API_KEY="your-api-key"
pytest tests/test_website/test_scraper_test_website_test_data_http.py -v -m integration
```

### Test Coverage

```bash
pytest tests/test_website/ --cov=test_website --cov-report=html
```
...
- Verify TEST_WEBSITE_API_KEY is set correctly
- Check API key is valid and not expired
- Ensure API key has required permissions

**Connection Errors:**
- Verify network connectivity to https://test.example.com
...
python -m claude_scraper.updater \
    --scraper scraper_test_website_test_data_http.py \
...
2. Review API documentation at https://test.example.com
